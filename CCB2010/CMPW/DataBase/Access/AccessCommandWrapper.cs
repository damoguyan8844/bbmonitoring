...
{
    /// <summary>
    /// <para>Represents an Access statement or stored procedure to execute against an Access database.</para>
    /// </summary>   
    public class AccessCommandWrapper : DBCommandWrapper
    {
        ...
        /// <summary>
        /// <para>Initialize a new instance of the <see cref="AccessCommandWrapper"/> class with the text of a query and the command type.</para>
        /// </summary>
        ...
        /// <summary>
        /// <para>Initialize a new instance of the <see cref="AccessCommandWrapper"/> class with the text of a query the command type, and the parameter values.</para>
        /// </summary>        
        /// <param name="commandText"><para>The stored procedure name or SQL sting the command represents.</para></param>
        /// <param name="commandType"><para>One of the <see crer="CommandType"/> values.</para></param>
        /// <param name="parameterToken"><para>The parameter delimeter for database commands.</para></param>
        /// <param name="parameterValues"><para>The parameter values to assign in positional order.</para></param>
        internal AccessCommandWrapper( string commandText, CommandType commandType, char parameterToken, object[] parameterValues )
        ...
        /// <summary>
        /// <para>Returns the value of the parameter for the given <paramref name="index"/>.</para>
        /// </summary>
        /// <param name="index"><para>The name of the parameter to get the value.</para></param>
        /// <returns><para>The name of the parameter.</para></returns>
